...
M3-01 runner. M3-02 extends the same schema/profile with twelve immutable
...
base VRAM copied before the later result tile transfers, the stable-result
palette that supersedes the earlier transition palette, and its retained/CPU-
written palette tail.
...
extension changes the exact rules identity and native inventory to twenty-five
