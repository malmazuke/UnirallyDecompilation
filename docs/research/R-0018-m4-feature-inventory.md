...
| AI and randomness | One BRONSEN opponent path and controlled finish continuation are observed. Existing evidence records opponent-AI continuation state but does not enumerate random seeds or alternative AI policies ([core guide](../../src/core/README.md), [R-0017 opponent-first](R-0017-m3-acceptance.md)). | One deterministic AI continuation from one semantic start is accepted. | AI/RNG seed inventory, alternative opponents, difficulty/options and repeatability across those domains are unobserved. |
...
| Game progression and persistence | A result screen is reached; stored-time/ranking/award semantics were left unknown ([R-0012 limits](R-0012-complete-race-evidence.md)). Emulator save/restore proves laboratory continuation, not original user progression. | Canonical in-race save/restore is exact across tested boundaries; the generated content pack persists installation content, not game progress ([R-0011](R-0011-m2-acceptance.md), [D-0005](../decisions/D-0005-classic-content-distribution.md)). | League/tour progression, unlocks, records, settings, original SRAM semantics, native save files and migrations are unobserved. |
